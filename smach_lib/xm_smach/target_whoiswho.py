...
0x21:{'name': 'living-room', 'pos': Pose(Point(2.459, -0.435, 0.000),Quaternion(0.000, 0.000, 0.920, -0.391)), 'mode': 1 },
0x22:{'name': 'bed-room', 'pos': Pose(Point(9.283, 0.304, 0.000),Quaternion(0.000, 0.000, 0.006, 1.000)), 'mode': 1 },
